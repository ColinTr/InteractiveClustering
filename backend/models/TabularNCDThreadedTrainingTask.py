...
from models.ThreadedTrainingTask import ThreadedTrainingTask
...
class TabularNCDThreadedTrainingTask(ThreadedTrainingTask):
    def __init__(self, dataset_name, target_name, known_classes, unknown_classes, selected_features, tsne_array, random_state, color_by, model_config, corresponding_tsne_config_name, TabularNCDModelToTrain,
        ...
        self.x_full = torch.tensor(x_full, device=self.device)
        ...
        for epoch in range(self.epochs):
            ...
            for batch_index in range(n_batchs):
                ...
                if self.use_unlab is False or self.use_unlab:
                    ...
                    labeled_similarities = F.cosine_similarity(encoded_x_lab.unsqueeze(1), encoded_x_lab,
                                                               dim=-1)
